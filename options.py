...
max_epoch = 1000       # 훈련을 위한 최대 epoch
display = 100           # 훈련 및 테스트의 표시 간격입니다. 예를 들어 `display=10`이면 프로그램은 10번의 반복 후에 한 번만 인쇄됩니다.
...
weights = './weights/swk_trained/_loss_14.012999534606934_wer_1.0_cer_0.9444444444444444.pt'
